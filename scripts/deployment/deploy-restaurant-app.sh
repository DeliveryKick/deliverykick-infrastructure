...
# Manual deployment script for Restaurant App
# Usage: ./deploy-restaurant-app.sh [dev|prod] [image-tag]
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Restaurant App Deployment${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
if [ "$ENVIRONMENT" = "prod" ]; then
    ...
    ECS_SERVICE="deliverykick-prod-restaurant"
    ECR_REPOSITORY="deliverykick-restaurant"
elif [ "$ENVIRONMENT" = "dev" ]; then
    ECS_CLUSTER="deliverykick-dev-cluster"
    ECS_SERVICE="deliverykick-dev-restaurant"
    ECR_REPOSITORY="deliverykick-restaurant-dev"
else
...
echo "1. Check logs: aws logs tail /ecs/deliverykick-${ENVIRONMENT}/restaurant --follow"
echo "2. Run migrations if needed: ./run-migrations.sh ${ENVIRONMENT} restaurant"
echo "3. Test the API"
echo ""
